...
//Arrays de pergunta  e a base de imagem
  ...
  imcAtual = this.navParams.get('imcAtual');// av1
...
// Variaveis com operações matematicas
  ...
  imcIdeal:any;//av3
  idIdeal:any;
  idDesejado = this.navParams.get('idDesejado');//av2
  idAtual = this.navParams.get('idAtual');//av1
  naoprimeiro:boolean;
  ...
  callAv4() {
    if (this.idade <= 13) {
      ...
      let av4 = this.modalCrtl.create(Avaliacao4Page, {
