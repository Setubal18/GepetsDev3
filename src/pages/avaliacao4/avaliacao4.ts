...
// Variaveis com operações matematicas
  ...
  imcReal = this.navParams.get('imcReal');//av1
  imcDesejado = this.navParams.get('imcDesejado');//av2
  imcIdeal = this.navParams.get('imcIdeal');//av3
  imcSexoOposto:any;//av4

  idDesejado=this.navParams.get('idDesejado');
  ...
  pushResult(){
    let result = this.modalCrtl.create(ResultadoPage,{avaliacao3:this.selecionado,
      ...
      imcAtual: this.imcAtual,//av1
      imcReal: this.imcReal,//real
      imcDesejado: this.imcDesejado,//av2
      idDesejado: this.idDesejado,//av2
      idAtual :this.idAtual,//av1
      idIdeal : this.navParams.get('idIdeal'), //av3
      idSexoOposto : this.idSexoOposto, //av4
      imcIdeal: this.imcIdeal,//av3
      imcSexoOposto: this.imcSexoOposto,//av4
